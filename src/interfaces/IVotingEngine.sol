...
interface IVotingEngine {
    ...
    ///        capped per-address by voteStake * VOTER_REWARD_CAP_MULTIPLIER (applied after the 3x multiplier).
    ///      - Unrevealed voters: stake - UNREVEAL_PENALTY_RATE_BP of stake (penalty enters reward pool).
